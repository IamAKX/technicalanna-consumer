...
public class QuizSolution extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        examsModel = (SubjectExamsModel) getIntent().getSerializableExtra("exammodel");
        quizList = examsModel.getQuizList();
        ansArray = getIntent().getIntArrayExtra("correctans");
    ...
    private void populateQuestion() {
        ...
        {
            optionArray[ansArray[currentQuestion-1]-1].setBorderColor(getResources().getColor(android.R.color.holo_red_light));
            optionArray[ansArray[currentQuestion-1]-1].setBackgroundColor(getResources().getColor(R.color.red_trans));

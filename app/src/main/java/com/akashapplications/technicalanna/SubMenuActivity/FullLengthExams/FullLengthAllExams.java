...
public class FullLengthAllExams extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_length_all_exams);
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                for (int i=0; i<arr.length(); i++)
                                {
                                    ...
                                    JSONArray rArray = object.getJSONArray("registered_user");
                                    for(int k =0; k<rArray.length(); k++)
                                        regUser.add(rArray.getString(k));
                                    m.setRegisteredUser(regUser);
